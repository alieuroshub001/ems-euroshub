  ...
  return (
    <div className="relative max-w-lg text-center text-white p-4 sm:p-8">
      ...
      <div className="mb-6 sm:mb-8">
        <div className="relative">
          <div className="absolute -top-2 -left-2 sm:-top-4 sm:-left-4 text-4xl sm:text-6xl text-white/20 font-serif select-none">&quot;</div>
          <blockquote className="text-lg sm:text-2xl lg:text-3xl font-light leading-relaxed tracking-wide px-4 sm:px-0">
            I have not failed. I&apos;ve just found 10,000 ways that won&apos;t work.
          </blockquote>
          <div className="absolute -bottom-2 -right-2 sm:-bottom-4 sm:-right-4 text-4xl sm:text-6xl text-white/20 font-serif rotate-180 select-none">&quot;</div>
        </div>
      </div>
...
LoginQuote.displayName = 'LoginQuote';
